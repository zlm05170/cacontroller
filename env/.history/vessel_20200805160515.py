...
class Vessel(actor.Actor):
    ...
    def get_damping_force_and_torque(self):
        ...
        first_order_damping_force_and_torque = self.first_order_damping_matrix * np.concatenate(velocity_translational_model_frame, velocity_rotational_model_frame) # questionable
