        ...
        while True:
            ...
            if not websocket.open:
                ...
                if actor2 != None:
                    #print(actor4)
                    clazz_ls(actor2)    
                actor3 = await evaluate(resp, 'GPSController', 'Target Ship 1')
                if actor3 != None:
                    clazz_ls(actor3) # ts1 = actor2
                actor4 = await evaluate(resp, 'GPSController', 'Target Ship 2')
                if actor4 != None:
                    clazz_ls(actor4) # ts2 = actor3
