...
async def start():
    ...
    actor_list = [gps_gunnerus, gps_target_ship_1, gps_target_ship_2, gunnerus_thruster_port, gunnerus_thruster_starboard]
        ...
        while True:
            ...
            if not websocket.open:
                ...
                for actor in actor_list:
                    actor_data = await evaluate(resp, actor['clazz'], actor['name'])
                    dump = clazz_ls(actor_data)
