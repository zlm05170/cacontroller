...
class RigidBody():
    ...
    def advance(self, external_force_world_frame, external_torque_world_frame, dt):
        ...
        cog_world_frame = self.rotation.rotate(self.center_of_gravity)
        position_cog = self.position + cog_world_frame + velocity_translational_world_frame * dt
        ...
        self.position = position_cog - cog_world_frame