...
# def get_port_value_by_index(port_list, index):
#     if index != None:
#         return(port_list[index]['value']['value'])
...
async def start():
    ...
    for name in port_info:
        port_info_ls.append(name)
    
    port_info_ls = ['Longitude', 'latitude', ]
    port_info_ls.append(?) # port_info's name
    ...
    #port_name_list = ['' for i in port_info_ls] # return a string -> port's name
            ...
            if not websocket.open:
                ...
                try:
                    ...
                    for i in range(len(actor_list)):
                        ...
                        if actor != None:
                            for i in range(len(port_info_ls)):
                                evaluate_port(actor, 'output', port_info_ls[i])                             
                except:
                    traceback.print_exc()               
        await sendmessage()
...
def evaluate_port(actor, port_type, port_name): # port_name is the list of name of port
    ...
    value = get_port_value_by_index(actor['output'], index)
    print(value)
